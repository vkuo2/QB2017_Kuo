...
```
Discusion: I had issues with getting the proper species names to appear as the title for the figures. I see that for these 4 species chosen at random from the BCI 1982 census data set that most species had higher probability for low site abundance.  
